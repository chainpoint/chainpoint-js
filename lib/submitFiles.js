...
/**
 * Submit hash(es) of selected file(s) to one or more Gateways, returning an Array of proof handle objects, one for each submitted hash and Gateway combination.
 ...
 * @return {Array<{path: String, uri: String, hash: String, proofId: String, groupId: String}>} An Array of Objects, each a handle that contains all info needed to retrieve a proof.
 */
